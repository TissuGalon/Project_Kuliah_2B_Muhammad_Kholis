                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-floating mb-3">
                                            <select class="form-select" aria-label="Default select example">
                                                ...
                                                <option value="1">Owne/Admin</option>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-floating mb-3">
                                            <input type="password" class="form-control" id="floatingInput"
                                                placeholder="Your Password" disable value="12345">
                        ...
                        <tbody>
                            ...
                            foreach ($result as $row) {
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex">
                                        <button class="btn btn-info btn-sn me-1" data-bs-toggle="modal"
                                            data-bs-target="#ModalView"><i class="bi bi-eye"></i></button>
                                        <button class="btn btn-warning btn-sn me-1"><i class="bi bi-pencil-square"></i></button>
                                        <button class="btn btn-danger btn-sn"><i class="bi bi-trash"></i></button>
                                    </td>
                                </tr>
                                <?php
                            }
